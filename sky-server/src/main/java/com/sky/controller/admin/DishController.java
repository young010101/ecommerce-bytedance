...
public class DishController {
    ...
    /**
     * Delete dishes by their IDs. Supports batch deletion by providing multiple
     * IDs.
     *
     ...
     * <p>
     * This method handles a POST request to update the status of a dish identified
     * by its ID.
     * The status parameter indicates whether the dish should be enabled (1) or
     * disabled (0).
     *
